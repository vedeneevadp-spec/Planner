...
const publicApiModules = [
  ...
  'widgets/sidebar',
  'features/cleaning',
  'features/cleaning/focus-query',
  'features/cleaning/offline-storage',
  'features/emoji-library',
  'features/habits',
  'features/habits/offline-storage',
  'features/planner',
  'features/planner/offline-storage',
  'features/self-care',
  'features/self-care/offline-storage',
  'features/session',
  'features/shopping-list',
  'features/shopping-list/filter-query',
  'features/shopping-list/offline-storage',
