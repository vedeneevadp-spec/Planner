...
const OPENAPI_DOCUMENTATION_BACKLOG = new Set([
  ...
  routeKey('get', '/api/v1/cleaning'),
  routeKey('get', '/api/v1/cleaning/today'),
  routeKey('post', '/api/v1/cleaning/tasks'),
  routeKey('patch', '/api/v1/cleaning/tasks/{taskId}'),
  routeKey('delete', '/api/v1/cleaning/tasks/{taskId}'),
  routeKey('post', '/api/v1/cleaning/tasks/{taskId}/complete'),
  routeKey('post', '/api/v1/cleaning/tasks/{taskId}/postpone'),
  routeKey('post', '/api/v1/cleaning/tasks/{taskId}/skip'),
  routeKey('post', '/api/v1/cleaning/zones'),
  routeKey('patch', '/api/v1/cleaning/zones/{zoneId}'),
  routeKey('delete', '/api/v1/cleaning/zones/{zoneId}'),
  ...
  routeKey('get', '/api/v1/habits'),
  routeKey('post', '/api/v1/habits'),
  routeKey('get', '/api/v1/habits/stats'),
  routeKey('get', '/api/v1/habits/today'),
  routeKey('patch', '/api/v1/habits/{habitId}'),
  routeKey('delete', '/api/v1/habits/{habitId}'),
  routeKey('put', '/api/v1/habits/{habitId}/entries/{date}'),
  routeKey('delete', '/api/v1/habits/{habitId}/entries/{date}'),
