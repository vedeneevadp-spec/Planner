...
function createSessionBaseQuery(executor: DatabaseExecutor) {
  return executor
    ...
    .select([
      ...
      'actor.default_time_zone as defaultTimeZone',
      'actor.energy_mode as energyMode',
      'actor.last_seen_time_zone as lastSeenTimeZone',
      'actor.shared_task_assigned_notifications_enabled as sharedTaskAssignedNotificationsEnabled',
      'actor.shared_task_created_notifications_enabled as sharedTaskCreatedNotificationsEnabled',
      'actor.shared_task_ready_for_review_notifications_enabled as sharedTaskReadyForReviewNotificationsEnabled',
      'actor.time_zone_mode as timeZoneMode',
      'actor.voice_assistant_enabled as voiceAssistantEnabled',
      ...
      'workspace.default_time_zone as workspaceDefaultTimeZone',
