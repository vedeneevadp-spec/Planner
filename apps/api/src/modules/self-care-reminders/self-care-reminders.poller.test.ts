...
import { SelfCareRemindersPoller } from './self-care-reminders.poller.js'
import type { SelfCareRemindersService } from './self-care-reminders.service.js'

void test('SelfCareRemindersPoller becomes unhealthy after repeated infrastructure failures', async () => {
  ...
  } as unknown as SelfCareRemindersService
  const poller = new SelfCareRemindersPoller(
    service,
    {
      error: () => undefined,
      info: () => undefined,
