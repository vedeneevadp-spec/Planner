...
> {
  return {
    ...
    SelfCareAnalyticsResponse: genericJsonObjectSchema(),
    SelfCareCompletion: genericJsonObjectSchema(),
    SelfCareCompletionInput: genericJsonObjectSchema(),
    SelfCareDailyState: genericJsonObjectSchema(),
    SelfCareDailyStateInput: genericJsonObjectSchema(),
    SelfCareDashboardResponse: genericJsonObjectSchema(),
    SelfCareHistoryResponse: genericJsonObjectSchema(),
    SelfCareItem: genericJsonObjectSchema(),
    SelfCareItemInput: genericJsonObjectSchema(),
    SelfCareItemScheduleInput: genericJsonObjectSchema(),
    SelfCareItemUpdateInput: genericJsonObjectSchema(),
    SelfCareListResponse: genericJsonObjectSchema(),
    SelfCareMinimumItemsUpdateInput: genericJsonObjectSchema(),
    SelfCareOccurrence: genericJsonObjectSchema(),
    SelfCareOccurrenceListResponse:
      genericJsonArraySchema('SelfCareOccurrence'),
    SelfCareOccurrenceMoveInput: genericJsonObjectSchema(),
    SelfCareOccurrenceSkipInput: genericJsonObjectSchema(),
    SelfCarePlanResponse: genericJsonObjectSchema(),
    SelfCareRangeInput: genericJsonObjectSchema(),
    SelfCareRitualCompletionInput: genericJsonObjectSchema(),
    SelfCareRitualStepsUpdateInput: genericJsonObjectSchema(),
    SelfCareSettingsResponse: genericJsonObjectSchema(),
    SelfCareSettingsUpdateInput: genericJsonObjectSchema(),
    SelfCareTemplate: genericJsonObjectSchema(),
    SelfCareTemplateCreateInput: genericJsonObjectSchema(),
    SelfCareTemplateListResponse: genericJsonArraySchema('SelfCareTemplate'),
