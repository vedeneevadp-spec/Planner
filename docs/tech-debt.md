...
Дата анализа: 2026-05-21. Обновлено: 2026-06-04.
...
- page CSS modules (`CalendarPage.module.css`, `CleaningPage.module.css`,
  `Sidebar.module.css`) разрастаются без отдельного style budget/lint gate
