...
- 10 секунд PCM 16 kHz mono 16-bit: 320 000 bytes;
...
x-stt-source: android_short_clip | android_push_to_talk
```
...
В первой версии cloud TTS не используется.
...
- короткий activation sound после wake word;
- вибрация;
- визуальный статус;
...
9. Не использовать cloud TTS в первой версии.
10. Использовать визуальное подтверждение вместо голосового ответа.
